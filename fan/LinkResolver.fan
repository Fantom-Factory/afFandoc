...
mixin LinkResolver {
	...
	** Returns a basic 'LinkResolver' that just returns the given the 'url'. 
	static LinkResolver passThroughResolver() {
		FuncLinkResolver() |DocElem elem, Str? scheme, Uri url -> Uri?| { url }
	}
	
	** Returns a 'LinkResolver' that returns the given the 'url' should it be prefixed with a '#'. 
	...
	** Returns a 'LinkResolver' that returns the given the 'url' should it be qualified with a 
	...
	** Returns a 'LinkResolver' that returns the given the 'url' should it be path absolute. 
